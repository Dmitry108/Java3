                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (str.startsWith("/authok")) {
                            //на сервере в отсылаемое сообщение добавлен логин, чтоб не создавать новую переменную
                            String[] s = str.split(" ");
                            setAuthenticated(true);
                            nickname = s[1];
                            hystory = new History(s[2]);
                            textArea.appendText(hystory.read(100).toString());
                            break;
                        }
/////////////////
                        if (str.equals("/end")) {
